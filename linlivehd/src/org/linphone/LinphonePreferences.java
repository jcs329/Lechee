...
public class LinphonePreferences {
	...
	/*Neil*/
	public void setRmspw(String pw){
		getConfig().setString("app", "rms_pw", pw);
	} 
	public String getRmspw(){
		return getConfig().getString("app", "rms_pw", "");
	}
	public void setRmsid(String id){
		getConfig().setString("app", "rms_id", id);
	} 
	public String getRmsid(){
		return getConfig().getString("app", "rms_id", "");
	} 
	public boolean getRmsflag(){
		return getConfig().getBool("app", "rms_flag", true );
	}
	public void setRmsflag(Boolean flag){
		getConfig().setBool("app", "rms_flag", flag );
	}
	public int getRmsport(){
		return getConfig().getInt("app", "rms_port", 80 );
	}
	public void setRmsport(int port){
		getConfig().setInt("app", "rms_port", port );
	}
/*
	public boolean isDebugMode(){
		return getConfig().getBool("app", "debug_mode", false );
	}
	public void setDebugMode(Boolean flag){
		getConfig().setBool("app", "debug_mode", flag );
	}
*/
	public String getRmsAddress(){
		return getConfig().getString("app", "rms_address", "rms03.vccloud.quantatw.com");
	}
	public void setRmsAddress(String address){
		getConfig().setString("app", "rms_address", address);
	} 
	public boolean isShowTutorials(){
		return getConfig().getBool("app", "tutorials_flag", false );
	}
	public void setTutorials(Boolean flag){
		getConfig().setBool("app", "tutorials_flag", flag );
	}
	public boolean isDeveloperMode(){
		return getConfig().getBool("app", "developer_mode", false );
	}
	public void setDeveloperMode(Boolean flag){
		getConfig().setBool("app", "developer_mode", flag );
	}
	public void setAccountProxyAndTransport(int n, String proxy, String transport) {
	...
	public TunnelConfig getTunnelConfig() {
		LinphoneCore lc = getLc();//Neil add
		if (lc != null) {//Neil add
		...
		Log.d("[Neil]getTunnelConfig():getLc()==Null");//Neil add
		return null;//Neil add
	}
