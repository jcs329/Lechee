...
public class GetAcAssetInfoCommandPack extends BaseResPack {
    private static final long serialVersionUID = -1199553594465256662L;

    private GetAcAssetInfoResPack data;

    public GetAcAssetInfoResPack getData() {
        return data;
    }

    public void setData(GetAcAssetInfoResPack data) {
        this.data = data;
    }
