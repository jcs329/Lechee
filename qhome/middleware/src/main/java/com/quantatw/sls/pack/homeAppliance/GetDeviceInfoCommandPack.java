...
public class GetDeviceInfoCommandPack extends BaseResPack {
    private static final long serialVersionUID = -4862797757814618187L;
    
    private GetDeviceInfoResPack data;

    public GetDeviceInfoResPack getData() {
        return data;
    }

    public void setData(GetDeviceInfoResPack data) {
        this.data = data;
    }
