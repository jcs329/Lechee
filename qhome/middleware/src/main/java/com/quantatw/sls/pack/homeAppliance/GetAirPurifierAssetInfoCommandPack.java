...
public class GetAirPurifierAssetInfoCommandPack extends BaseResPack {
    private static final long serialVersionUID = -910792457329869409L;

    private GetAirPurifierAssetInfoResPack data;

    public GetAirPurifierAssetInfoResPack getData() {
        return data;
    }

    public void setData(GetAirPurifierAssetInfoResPack data) {
        this.data = data;
    }
