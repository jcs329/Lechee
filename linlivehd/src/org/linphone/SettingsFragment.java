...
import org.linphone.tutorials.LiveHDTutorialActivity;
...
public class SettingsFragment extends PreferencesListFragment implements EcCalibrationListener {
	...
	private void initSettings() {
		...
		/*Neil ADD*/
		// Add action on Help button
		findPreference(getString(R.string.menu_help_key)).setOnPreferenceClickListener(new OnPreferenceClickListener() {
			@Override
			public boolean onPreferenceClick(Preference preference) {
				Intent intent = new Intent();
				intent.setClass(getActivity(),LiveHDTutorialActivity.class);
	...
	private void hideSettings() {
		...
		if(!mPrefs.isDeveloperMode()){
			emptyAndHidePreference(R.string.pref_preferences_key);
		}
	}
	...
	private void initNetworkSettings() {
		...
		//((CheckBoxPreference) findPreference(getString(R.string.pref_debug_mode_key))).setChecked(mPrefs.isDebugMode());
	}
	...
	private void setNetworkPreferencesListener() {
		...
		/*
		findPreference(getString(R.string.pref_debug_mode_key)).setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			@Override
			public boolean onPreferenceChange(Preference preference, Object newValue) {
				mPrefs.setDebugMode((Boolean) newValue);
				return true;
			}
		});
		*/
