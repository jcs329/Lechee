...
#LiangBin add, openssl
SSL_C_INCLUDE= \
	$(linphone-root-dir)/submodules/externals/openssl/include
include $(linphone-root-dir)/submodules/externals/build/openssl/Android.mk
...
#AES
include $(linphone-root-dir)/jni/Android_aes.mk
