...
public class GetAirPurifierAssetInfoResPack extends BaseAssetResPack {
     ...
     */
    public static final Creator<GetAirPurifierAssetInfoResPack> CREATOR = new Creator<GetAirPurifierAssetInfoResPack>() {
         ...
         */
        public GetAirPurifierAssetInfoResPack createFromParcel(Parcel in) {
            // Read serialized concrete strategy from parcel
            return (GetAirPurifierAssetInfoResPack) in.readSerializable();
        }

        /**
         * Required by Creator
         */
        public GetAirPurifierAssetInfoResPack[] newArray(int size) {
            return new GetAirPurifierAssetInfoResPack[size];
        }
    };
}
