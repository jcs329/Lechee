...
public class GetAbilityLimitAcCommandPack extends BaseResPack {
    private static final long serialVersionUID = -2794722662916340222L;

    private GetAbilityLimitAcResPack data;

    public GetAbilityLimitAcResPack getData() {
        return data;
    }

    public void setData(GetAbilityLimitAcResPack data) {
        this.data = data;
    }
