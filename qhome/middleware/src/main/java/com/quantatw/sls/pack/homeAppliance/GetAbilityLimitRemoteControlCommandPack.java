...
public class GetAbilityLimitRemoteControlCommandPack extends BaseResPack {
    private static final long serialVersionUID = 1949106980173783997L;

    private GetAbilityLimitRemoteControlResPack data;

    public GetAbilityLimitRemoteControlResPack getData() {
        return data;
    }

    public void setData(GetAbilityLimitRemoteControlResPack data) {
        this.data = data;
    }
