...
public class GetPMAssetInfoCommandPack extends BaseResPack {
    private static final long serialVersionUID = -5501334604421385412L;

    private GetPMAssetInfoResPack data;

    public GetPMAssetInfoResPack getData() {
        return data;
    }

    public void setData(GetPMAssetInfoResPack data) {
        this.data = data;
    }
